...
public class Page {
    private int pageSize=10; // 게시 글 수
    ...
    public void setResult(List resultList) {
        PageList list = (PageList) resultList;
        this.setTotalCount(list.getPaginator().getTotalCount());
    }
    ...
    private void makeBlock(){
        int blockEndPage = ((int)Math.ceil((double)this.pageNo / (double)this.blockSize)) * this.blockSize;
        if(this.finalPageNo<blockEndPage) {
            this.endPageNo = this.finalPageNo;
        }else {
            this.endPageNo = blockEndPage;
        }
        this.startPageNo = blockEndPage -this.blockSize+1;
    ...
    public String toString() {
        return "Page [pageSize=" + pageSize + ", firstPageNo=" + firstPageNo + ", prevPageNo=" + prevPageNo
